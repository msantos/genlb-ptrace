...
/* intercept and modify syscalls in subprocess */
#ifdef __NR_ptrace
      SC_ALLOW(ptrace),
#endif
#ifdef __NR_process_vm_readv
      SC_ALLOW(process_vm_readv),
#endif
#ifdef __NR_process_vm_writev
      SC_ALLOW(process_vm_writev),
#endif

/* socket operations: originate connect(2) on behalf of subprocess */
#ifdef __NR_socket
      SC_ALLOW(socket),
#endif
#ifdef __NR_connect
